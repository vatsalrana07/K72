...
const Navbar = () => {
    ...
    return (
        <div className='flex fixed top-0 w-full items-start justify-between z-20'>
            <div className='p-3'>
                <a href="/">
                <div className='w-30 max-[700px]:w-25'>
            ...
            <div className='relative bg-black h-14 w-[16vw] max-[700px]:w-[49vw]' 
            onClick={() => {
                setNavOpen(true);
            }}
            onMouseEnter={() => {
                ...
                <div className='relative h-full px-6 flex flex-col gap-1 justify-center items-end cursor-pointer'>
                    <div className='w-15 h-0.5 bg-white max-[700px]:w-10 max-[700px]:h-[1px]'></div>
                    <div className='w-9 h-0.5 bg-white max-[700px]:w-7 max-[700px]:h-[1px]'></div>
                </div>
            </div>
        </div>
    )
